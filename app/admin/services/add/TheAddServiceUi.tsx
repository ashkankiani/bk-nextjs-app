...
export default function TheAddServiceUi() {
  ...
  const onSubmit = async (data: TypeFormService) => {
    ...
    const transformedData: TypeApiAddServiceReq = {
      ...
      descriptionAfterPurchase: (data.descriptionAfterPurchase && data.descriptionAfterPurchase.length === 0) ? null : data.descriptionAfterPurchase,
    }


    await mutateAsyncAddService(transformedData).then((res) => {
        ...
        <form className="panel-boxed" onSubmit={handleSubmit(onSubmit)}>
          <div className="flex-center-start flex-wrap">
            ...
            <div className="panel-col-33">
              ...
              <div className="panel-row-checkbox">
                <label><input type="checkbox" className="bk-checkbox" {...register('smsToAdminService')}/>مدیر سرویس</label>
                <label><input type="checkbox" className="bk-checkbox" {...register('smsToAdminProvider')}/>ارائه دهنده</label>
            ...
            <div className="panel-col-33">
              ...
              <div className="panel-row-checkbox">
                <label><input type="checkbox" className="bk-checkbox" {...register('emailToAdminService')}/>مدیر سرویس</label>
            ...
            <div className="panel-col-100">
              ...
              <textarea
                {...register('description')} rows={5} className="bk-input text-right"/>
            </div>
            <div className="panel-col-100">
            ...
            <div className="panel-col-100">
              <button
                className={
                  'panel-form-submit ' +
                  (isPendingAddService ? 'disable-action' : '')
                }
                type="submit">
                {isPendingAddService ? (
                  <TheSpinner/>
