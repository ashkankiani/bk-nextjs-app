      ...
      <HeaderPage title="تنظیمات" description="تنظیمات ظاهری و نمایشی و پیکربندی وب سرویس خود را انجام دهید.">
        {
          ...
          <Link href="/admin/connections" className="action">
            <TbPlugConnected size="24px" className="inline-flex align-middle ml-2"/>
          ...
          isLoadingSettings ?
            ...
            <form className="panel-boxed" onSubmit={handleSubmit(onSubmit)}>
              <div className="flex-center-start flex-wrap">
                ...
                <div className="panel-col-33">
                  <label>پوسته ظاهری سایت<span>*</span></label>
                  <select
                    {...register('theme', {
                      required: {
                        value: true,
                ...
                <div className="panel-col-33">
                  <label>حداقل زمان شروع رزرو<span>*</span></label>
                  <input
                ...
                <div className="panel-col-33">
                  <label>حداکثر زمان پایان رزرو<span>*</span></label>
                  <input
                ...
                <div className="panel-col-33">
                  <label>حداقل دقیقه قبل شروع رزرو<span>*</span></label>
                  <input
                ...
                <div className="panel-col-33">
                  <label>وضعیت پیش فرض رزرو<span>*</span></label>
                  <select
                ...
                <div className="panel-col-33">
                  <label>امکان لغو رزرو برای کاربر<span>*</span></label>
                  <select
...
*/}
                <div className="panel-col-33">
                  <label>اطلاع رسانی پیامکی لغو رزرو<span>*</span></label>
                  <select
                    ...
                    <option value="ADMIN_PROVIDER_USER">ارسال به مدیر سرویس + ارائه دهنده + کاربر</option>
                  </select>
                  <FormErrorMessage errors={errors} name="smsCancellationReservation"/>
                </div>
                <div className="panel-col-33">
                  <label>اطلاع رسانی ایمیل لغو رزرو<span>*</span></label>
                  <select
                ...
                <div className="panel-col-33">
                  <label>حداقل دقیقه مورد نیاز قبل از لغو<span>*</span></label>
                  <input
                ...
                <div className="panel-col-33">
                  <label>امکان رزرو گروهی<span>*</span></label>
                  <select
                ...
                <div className="panel-col-33">
                  <label>وضعیت ایمیل در ایجاد کاربر<span>*</span></label>
                  <select
                ...
                <div className="panel-col-33">
                  <label>حداکثر تعداد رزرو کاربر در روز<span>*</span><span className="fa-regular-14px">رزرو نامحدود = 0</span></label>
                  <input
                ...
                <div className="panel-col-33">
                  <label>حداکثر تعداد نوبت در ماه<span>*</span><span className="fa-regular-14px">رزرو نامحدود = 0</span></label>
                  <input
                ...
                <div className="panel-col-33">
                  <label>وضعیت باکس روزهای بدون نوبت کاری<span>*</span></label>
                  <select
                    ...
                    className="bk-input">
                    <option value="true">بله، اگر نوبت کاری در آن روز وجود ندارد باکس را نمایش بده.</option>
                    <option value="false">خیر، اگر نوبت کاری در آن روز وجود ندارد باکس را نمایش نده.</option>
                  </select>
                  <FormErrorMessage errors={errors} name="shiftWorkStatus"/>
                </div>
                <div className="panel-col-33">
                  <label>اجازه جستجوی نوبت کاری<span>*</span></label>
                  <select
                ...
                <div className="panel-col-33">
                  <label>ثبت نام کاربر با تایید شماره موبایل<span>*</span></label>
                  <select
                    ...
                    className="bk-input">
                    <option value="true">بله، هنگام ثبت نام کاربر باید شماره موبایل خود را تایید نماید.</option>
                    <option value="false">خیر، هنگام ثبت نام نیازی به تایید شماره موبایل کاربر نیست.</option>
                  </select>
                  <FormErrorMessage errors={errors} name="registerOTP"/>
                </div>

                <div className="panel-col-33">
                  <label>ورود کاربر با کد تایید یکبار مصرف پیامکی<span>*</span></label>
                  <select
                    {...register('loginOTP', {
                      required: {
                        value: true,
                    ...
                    className="bk-input">
                    <option value="true">بله، هنگام ورود کاربر میتواند با روش کد یکبار مصرف وارد سیستم شود.</option>
                    <option value="false">خیر، هنگام ورود کاربر با کدملی و رمزعبور وارد سیستم شود.</option>
                  </select>
                  <FormErrorMessage errors={errors} name="loginOTP"/>
                </div>

                <div className="panel-col-33">
                  <label>وضعیت ایجاد سبد خرید<span>*</span></label>
                  <select
                    {...register('cart', {
                      required: {
                        value: true,
                ...
                <div className="panel-col-33">
                  <label>حداقل مدت زمان قفل نوبت انتخاب شده<span>*</span></label>
                  <input
                ...
                <div className="panel-col-33">
                  <label>رزرو سریع به عنوان مهمان<span>*</span></label>
                  <select
