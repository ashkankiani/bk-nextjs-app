...
export default function TheHolidaysUi() {
    ...
    const {mutateAsync: mutateAsyncDeleteHoliday, isPending: isPendingDeleteHoliday} = useDeleteHoliday()


    const handlerDeleteHoliday = async (id: number, close: () => void) => {
        await mutateAsyncDeleteHoliday({id}).then((res) => {
                                                                ...
                                                                <div className="panel-wrapper-modal max-w-[500px]">
                                                                    ...
                                                                    <div className="panel-modal-content">
                                                                        <p>آیا از حذف تاریخ<strong
                                                                            className="px-1 text-red-500">{item.date}</strong>مطمن
                                                                            هستید؟</p>
                                                                    </div>
                                                                    <div className="panel-modal-footer">
                                                                        <div
                                                                            className={"panel-modal-confirm-delete " + (isPendingDeleteHoliday ? "disable-action" : "cursor-pointer")}
