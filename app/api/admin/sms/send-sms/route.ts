import {
    checkMethodAllowed, checkRequiredFields, createErrorResponseWithMessage, createSuccessResponseWithData,
                ...
                switch (type) {
                    ...
                    case "cancellationReservation" :
                        if (!connections[0].smsCodePattern2 || connections[0].smsCodePattern2.length === 0) {
                            return createErrorResponseWithMessage('کد پترن smsCodePattern2 برای cancellationReservation');
                        }
                        params = {
                    ...
                    case "confirmReservation" :
                        if (!connections[0].smsCodePattern3 || connections[0].smsCodePattern3.length === 0) {
                            return createErrorResponseWithMessage('کد پترن smsCodePattern3 برای confirmReservation');
                        }
                        params = {
                    ...
                    case "changeStatusReservation" :
                        if (!connections[0].smsCodePattern4 || connections[0].smsCodePattern4.length === 0) {
                            return createErrorResponseWithMessage('کد پترن smsCodePattern4 برای changeStatusReservation');
                        }
                        params = {
                    ...
                    case "reminderReservation" :
                        if (!connections[0].smsCodePattern5 || connections[0].smsCodePattern5.length === 0) {
                            return createErrorResponseWithMessage('کد پترن smsCodePattern5 برای reminderReservation');
                        }
                        params = {
                    ...
                    case "appreciationReservation" :
                        if (!connections[0].smsCodePattern6 || connections[0].smsCodePattern6.length === 0) {
                            return createErrorResponseWithMessage('کد پترن smsCodePattern6 برای appreciationReservation');
                        }
                        params = {
