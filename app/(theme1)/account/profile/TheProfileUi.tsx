        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-4 columns-1">
            <select
              ...
              className="bk-input"
            >
              <option value="" disabled hidden={user.gender !== 'NONE'}>
                جنسیت
              </option>
          ...
          <div className="relative mb-4 columns-1">
            <input
              ...
              className="bk-input"
              placeholder="تکرار کلمه عبور (اختیاری)"
            />
            <span className="absolute left-4 top-4 cursor-pointer leading-6 text-neutral-400">
              {passwordRepeatShown ? (
                <FiEye
