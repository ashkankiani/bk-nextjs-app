...
import {hookAddDiscount} from "@/hooks/admin/hookDiscount";
...
export default function AddDiscount() {
  ...
  const addDiscount = async data => {
    setLoading(true)
    await hookAddDiscount(data, (response, message) => {
      setLoading(false)
      if (response) {
                    ...
                    >
                      <div className="flex-center-center pb-2">
                        <div
                          ...
                          onClick={() => {
                            setValue('startDate', undefined), refStartDate.current.closeCalendar()
                          }}
                        >
                          ریست
                        </div>
                    ...
                    >
                      <div className="flex-center-center pb-2">
                        <div
                          className="panel-date-picker-reset"
                          onClick={() => {
                            setValue('endDate', undefined), refEndDate.current.closeCalendar()
                          }}
                        >
                          ریست
                        </div>
