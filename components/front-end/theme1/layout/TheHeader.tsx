...
export default function TheHeader() {
  ...
  return (
    <header>
      <div className="flex-center-between gap-4 flex-col sm:flex-row mb-8">
        <Link href="/">
        ...
        <div className="flex-center-center gap-x-2">
          <SelectTheme/>
          {
            isLogin ?
              <>
                <Link href="/account/reservation"
                      className="bk-button bg-green-700 p-2">
                ...
                <Link href="/account/profile"
                      className="bk-button bg-primary-700 p-2">
                  <CgProfile size="22px"/>
                </Link>
                <Link href="/checkout"
                      className="bk-button bg-emerald-800 p-2">
                  <BsCart3 size="22px"/>
                </Link>
                <div onClick={() => router.push('/account/sign-out')}
                     className="bk-button bg-red-700 p-2 cursor-pointer">
                  <BiExit size="22px"/>
                </div>
              </>
              :
