...
export default function TheConnectionsUi() {
  ...
  const itemsInteger = ['id', 'smtpPort']
  ...
  const { mutateAsync: mutateAsyncUpdateConnection, isPending: isPendingUpdateConnection } =
    useUpdateConnection()
  ...
  const onSubmit = async (data: TypeApiConnection) => {
    ...
    await mutateAsyncUpdateConnection(data)
      .then(res => {
      ...
      <HeaderPage title="ارتباطات" description="ارتباطات و پیگربندی وب سرویس خود را انجام دهید.">
        {permissions.viewSettings && (
          <Link href="/admin/connections" className="action">
            <AiOutlineSetting size="24px" className="ml-2 inline-flex align-middle" />
            ...
            <form className="panel-boxed" onSubmit={handleSubmit(onSubmit)}>
              <div className="flex-center-start flex-wrap">
                ...
                <div className="panel-col-75">
                  ...
                  <input {...register('merchantId1')} type="text" className="bk-input" />
                  <FormErrorMessage errors={errors} name="merchantId1" />
                </div>
                <div className="panel-col-25">
                  <label>درگاه بانکی دوم</label>
                  <select {...register('bankName2')} defaultValue="NONE" className="bk-input">
                    <option value="NONE">غیرفعال</option>
                    <option value="ZARINPAL">زرین پال</option>
                    <option value="ZIBAL">زیبال</option>
                    <option value="AQAYEPARDAKHT">آقای پرداخت</option>
                ...
                <div className="panel-col-75">
                  ...
                  <input {...register('merchantId2')} type="text" className="bk-input" />
                ...
                <div className="panel-col-33">
                  ...
                  <select {...register('smsName')} defaultValue="NONE" className="bk-input">
                    <option value="NONE">غیرفعال</option>
                ...
                <div className="panel-col-25">
                  <label>
                    کد پترن لغو رزرو
                    <span className="fa-regular-14px">خالی باشد = پیامک لفو ارسال نمی شود</span>
                  </label>
                  <input
                ...
                <div className="panel-col-25">
                  ...
                  <input {...register('smtpURL')} type="text" className="bk-input" />
                ...
                <div className="panel-col-25">
                  ...
                  <input {...register('smtpUserName')} type="text" className="bk-input" />
                  <FormErrorMessage errors={errors} name="smtpUserName" />
                </div>
                <div className="panel-col-25">
                  <label>کلمه عبور</label>
                  <input {...register('smtpPassword')} type="text" className="bk-input" />
                ...
                {permissions.editConnections && (
                  <div className="panel-col-100">
                    <button
                      className={
                        'panel-form-submit ' + (isPendingUpdateConnection ? 'disable-action' : '')
                      }
                      type="submit"
                    >
