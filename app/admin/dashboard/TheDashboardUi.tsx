  ...
  const handlerCountReservationsTotal = async () => {
    ...
    await hookListReservations((response, message) => {
      if (response) {
        ...
        let filteredYesterday = message.filter(
          item =>
            item.date ===
            PNtoEN(
              dateNowP()
        ...
        let filteredToday = message.filter(
          item =>
            item.date ===
            PNtoEN(dateNowP().setHour(0).setMinute(0).setSecond(0).setMillisecond(0).format())
        )
        let filteredTomorrow = message.filter(
          item =>
            item.date ===
            PNtoEN(
              dateNowP()
            ...
            <>
              <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="panel-boxed">
                  ...
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    <span className="fa-regular-16px">فروش کل</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {numberWithCommas(sumPricesForDoneStatus(reservationsTotal, ['DONE']))}
                      <span className="fa-regular-14px mr-1 align-middle">تومان</span>
                    </span>
                  </div>
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    <span className="fa-regular-16px">فروش دیروز</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {numberWithCommas(sumPricesForDoneStatus(reservationsYesterday, ['DONE']))}
                      <span className="fa-regular-14px mr-1 align-middle">تومان</span>
                    </span>
                  </div>
                  <div className="flex-center-between py-2">
                    ...
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {numberWithCommas(sumPricesForDoneStatus(reservationsToday, ['DONE']))}
                      <span className="fa-regular-14px mr-1 align-middle">تومان</span>
                    </span>
                  </div>
                </div>
                <div className="panel-boxed">
                  ...
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    ...
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {numberWithCommas(
                        sumPricesForDoneStatus(reservationsToday, ['COMPLETED', 'REVIEW'])
                      )}
                      <span className="fa-regular-14px mr-1 align-middle">تومان</span>
                    </span>
                  </div>
                  <div className="flex-center-between py-2">
                    ...
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {numberWithCommas(
                        sumPricesForDoneStatus(reservationsTomorrow, ['COMPLETED', 'REVIEW'])
                      )}
                      <span className="fa-regular-14px mr-1 align-middle">تومان</span>
                    </span>
                  </div>
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                <div className="panel-boxed">
                  ...
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    ...
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsYesterday).REVIEW}
                    </span>
                  </div>
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    <span className="fa-regular-16px">رزروهای تکمیل شده</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsYesterday).COMPLETED}
                    </span>
                  </div>
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    <span className="fa-regular-16px">رزروهای انجام شده</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsYesterday).DONE}
                    </span>
                  </div>
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    <span className="fa-regular-16px">رزروهای لغو شده</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsYesterday).CANCELED}
                    </span>
                  </div>
                  <div className="flex-center-between py-2">
                    <span className="fa-regular-16px">رزروهای رد شده</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsYesterday).REJECTED}
                    </span>
                  </div>
                </div>
                <div className="panel-boxed">
                  ...
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    <span className="fa-regular-16px">رزروهای در صف بررسی</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsToday).REVIEW}
                    </span>
                  </div>
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    <span className="fa-regular-16px">رزروهای تکمیل شده</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsToday).COMPLETED}
                    </span>
                  </div>
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    <span className="fa-regular-16px">رزروهای انجام شده</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsToday).DONE}
                    </span>
                  </div>
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    <span className="fa-regular-16px">رزروهای لغو شده</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsToday).CANCELED}
                    </span>
                  </div>
                  <div className="flex-center-between py-2">
                    <span className="fa-regular-16px">رزروهای رد شده</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsToday).REJECTED}
                    </span>
                  </div>
                </div>
                <div className="panel-boxed">
                  ...
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    <span className="fa-regular-16px">مجموع رزروها</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {reservationsTomorrow.length}
                    </span>
                  </div>
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    <span className="fa-regular-16px">رزروهای در صف بررسی</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsTomorrow).REVIEW}
                    </span>
                  </div>
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    <span className="fa-regular-16px">رزروهای تکمیل شده</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsTomorrow).COMPLETED}
                    </span>
                  </div>
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    <span className="fa-regular-16px">رزروهای انجام شده</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsTomorrow).DONE}
                    </span>
                  </div>
                  <div className="flex-center-between border-b py-2 dark:border-darkNavy2">
                    <span className="fa-regular-16px">رزروهای لغو شده</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsTomorrow).CANCELED}
                    </span>
                  </div>
                  <div className="flex-center-between py-2">
                    <span className="fa-regular-16px">رزروهای رد شده</span>
                    <span className="fa-bold-22px sm:fa-bold-26px">
                      {countStatuses(reservationsTomorrow).REJECTED}
                    </span>
                  </div>
                </div>
              </div>
