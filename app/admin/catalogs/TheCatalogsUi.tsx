...
export default function TheCatalogsUi() {
    ...
    const {mutateAsync: mutateAsyncDeleteCatalog, isPending: isPendingDeleteCatalog} = useDeleteCatalog()


    const handlerDeleteCatalogs = async (id: number, close: () => void) => {
        await mutateAsyncDeleteCatalog({id}).then((res) => {
                                                ...
                                                <div className="flex-center-center gap-3">
                                                    {
                                                        ...
                                                        <Link href={"/admin/catalogs/" + item.id}><MdOutlineLocalPolice
                                                            size="26px"/></Link>
                                                    }
                                                    {
                                                        ...
                                                        >
                                                            {(close: () => void) =>
                                                                <div className="panel-wrapper-modal max-w-[500px]">
                                                                    ...
                                                                    />
                                                                    <div className="panel-modal-title">حذف سطح دسترسی
                                                                    </div>
                                                                    ...
                                                                    <div className="panel-modal-footer">
                                                                        <div
                                                                            className={"panel-modal-confirm-delete " + (isPendingDeleteCatalog ? "disable-action" : "cursor-pointer")}
