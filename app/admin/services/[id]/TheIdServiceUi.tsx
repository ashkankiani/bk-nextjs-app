...
export default function TheIdServiceUi() {
    ...
    const {data: dataService, isLoading: isLoadingService, isFetched: isFetchedService} = useShowService(id, {
        enabled: isLoadingUsers,
    })
    const {mutateAsync: mutateAsyncUpdateService, isPending: isPendingUpdateService} = useUpdateService()
    ...
    const onSubmit = async (data: TypeFormService) => {
        ...
        await mutateAsyncUpdateService(transformedData).then((res) => {
                            ...
                            <div className="flex-center-start flex-wrap">
                                ...
                                <div className="panel-col-100">
                                    <button
                                        className={
                                            'panel-form-submit ' +
                                            (isPendingUpdateService ? 'disable-action' : '')
                                        }
                                        type="submit">
