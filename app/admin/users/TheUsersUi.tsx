      ...
      <HeaderPage title="کاربران" description="در اینجا لیست کاربران را مشاهده کنید.">
        {permissions.importUsers && (
          <Link href="/admin/users/import-users" className="action">
            <RiFileExcel2Fill size="24px" className="ml-2 inline-flex align-middle" />
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      {permissions.viewReservation && (
                        <Link
                          href={'/admin/users/reservations/' + item.id}
                            ...
                            {(close: () => void) => (
                              <div className="panel-wrapper-modal max-w-[500px]">
                                ...
                                <div className="panel-modal-content">
                                  <p>
                                    آیا از حذف کاربر
                                    <strong className="px-1 text-red-500">{item.fullName}</strong>
                                    مطمن هستید؟
                                  </p>
                                  <p className="my-4">
                                    بدانید که با حذف کاربر، همه رزروها، فاکتورها و... این کاربر حذف
                                    می شوند.
                                  </p>
                                  <p>
                                    چنانچه در حال حذف ارائه دهنده هستید باید ابتدا ارائه های این
                                    ارائه دهنده را حذف کنید.
                                  </p>
                                </div>
                                <div className="panel-modal-footer flex-col">
                                  <p className="fa-regular-18px mt-2">
                                    حتما باید همه رزروها با هر وضعیتی، که برای این کاربر ایجاد شده
                                    است را ابتدا حذف نمایید.
                                  </p>
                                  <div
                                    className={
