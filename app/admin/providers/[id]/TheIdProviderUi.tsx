...
export default function TheIdProviderUi() {
  ...
  const {data: dataProvider, isLoading: isLoadingProvider, isFetched: isFetchedProvider} = useShowProvider(id , {
    enabled: isLoadingUsers,
  })


  const {mutateAsync: mutateAsyncUpdateProvider, isPending: isPendingUpdateProvider} = useUpdateProvider()
  ...
  const onSubmit = async (data: TypeFormProvider) => {
    ...
    await mutateAsyncUpdateProvider(transformedData).then((res) => {
              ...
              <div className="flex-center-start flex-wrap">
                ...
                <div className="panel-col-100">
                  <button
                    className={
                      'panel-form-submit ' +
                      (isPendingUpdateProvider ? 'disable-action' : '')
                    }
                    type="submit">
