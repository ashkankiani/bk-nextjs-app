...
import {hookAddProvider} from "@/hooks/admin/hookProvider";
import {hookListServicesWhere} from "@/hooks/admin/hookService";
...
export default function AddProvider() {
    ...
    const addProvider = async data => {
        setLoading(true)
        await hookAddProvider(data, (response, message) => {
            setLoading(false)
            if (response) {
    ...
    const handlerListServicesWhere = async () => {
        ...
        await hookListServicesWhere(params, (response, message) => {
